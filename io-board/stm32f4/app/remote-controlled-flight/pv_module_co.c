...
pv_msg_uavData iInputData;
pv_msg_controlData iControlBeagleData;
pv_msg_controlData oControlOutputData;
...
void module_co_init() 
{
  ...
  pv_interface_co.iInputData          = xQueueCreate(1, sizeof(pv_msg_uavData));
  pv_interface_co.iControlBeagleData  = xQueueCreate(1, sizeof(pv_msg_controlData));
  /*Data produced by the thread*/
  pv_interface_co.oControlOutputData  = xQueueCreate(1, sizeof(pv_msg_controlData));
